    ...
    <div id="sr_cumm_date1" class="sr_cumm_date" style="width:11.2em;">
        <form>
            ...
            <span id ="sr_custom_date" style ="display : none;">
                ...
                <input id = "sr_custom_date_submit" type="button" class="button" style="margin-left:1.4em; margin-top:-2px; -webkit-box-shadow: none; box-shadow: none;" value="<?php _e('Go', $sr_text_domain); ?>">
        ...
        <script type="text/javascript">
                    ...
                    $("#sr_smart_date_select").on('change',function(){
                        ...
                        if(smartdateValue == "CUSTOM_DATE"){
                            ...
                            if ( $(window).width() <= 557 ) { //for mobile screens
                                ...
                                $('#sr_cumm_date1').css({"width" :"36.5em"});
                            }
                            ...
                            if ( $(window).width() <= 557 ) { //for mobile screens
                                $("#sr_custom_date").css({ "margin-top": "3.6em"});
                        ...
                        <?php } else {?>
                            if (smartdateValue !== "CUSTOM_DATE") {
                              alert("Sorry! Smart Date functionality is available only in Pro version");  
								              ...
								              // Code for handling the custom date in Lite
                              get_data();
                              get_data_flag = true;
                            }
                        <?php }?>
            ...
            jQuery(function($){
                    ...
                    onSelect: function() {
                          ...
                          var end_min_date;
                            ...
                            <?php if ($fileExists) { ?>
                              ...
                              $('#startdate_display').datepick('option', 'maxDate', new Date());
                            ...
                            <?php } else { ?>
                                ...
                                if($("#startdate").val() != '') {
                                  if( new Date($("#startdate").val()).getTime() >= new Date($("#enddate").val()).getTime() ) {
                                    $('#startdate_display').datepick('option', 'maxDate', new Date($("#enddate").val()));
                                  }
                                }
                ...
                $('#enddate_display').datepick({dateFormat: date_format,
                    ...
                    onSelect: function() {
                          ...
                          <?php if ($fileExists) { ?>
                              ...
                              if($("#startdate").val() != '') {
                                  if( new Date($("#startdate").val()).getTime() > new Date($("#enddate").val()).getTime() ) {
                                    $('#startdate_display').datepick('option', 'defaultDate', new Date($("#enddate").val()));
                                    $('#startdate_display').datepick('option', 'maxDate', new Date($("#enddate").val()));
                                  } else {
                                    $('#startdate_display').datepick('option', 'maxDate', new Date());
                                  }
                ...
                jQuery(document).on( 'ready', function() {
                    ...
                    jQuery('.wc-rating-link').parent('p').hide();

                    if ( jQuery(window).width() <= 557 ) { //for mobile screens
                        jQuery("#sr_custom_date").css({ "height": "2.3em"});
                    }

          					//Code for displaying Custom Date in Lite
                    <?php
                    if (defined('SRPRO') && SRPRO === false) {
                    ?>
                      jQuery('#sr_cumm_date1').css({"width" :"36.5em"});
                      jQuery("#sr_custom_date").css({ "display" : "block"});
                    <?php } ?>
