<?php 
/**
Template Name:Landing: Take it Off - Page 6
 *
 * Template for the Take it Off Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/take-it-off.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="take-it-off-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/take-it-off-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/take-it-off-centered.jpg" alt="Take it Off! Spa Deals!" /></a>
