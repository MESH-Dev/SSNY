<?php 
/**
Template Name:Landing: Spring Fling - LHR (no Skin Care)
 *
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="spring-fling-lhr-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-home-lhr.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-centered-lhr.jpg" alt="Background Image" /></a>
				...
				<div class="shop-sales-wrapper">
					...
					<h1>4 EXCLUSIVE ONLINE OFFERS!</h1>
