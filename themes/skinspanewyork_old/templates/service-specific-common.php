...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/templates/styles/single-service-offers.css" />
	
	<?php
		if($custom_css_file){ ?>
			<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/templates/styles/<?php echo $custom_css_file; ?>" />
	<?php } ?>
	
	<style>
		html {
			background: url('<?php echo WP_CONTENT_URL ?>/themes/skinspanewyork/templates/images/single-service-offers/bg<?php echo rand(1,3); ?>.jpg') no-repeat center center fixed; 
