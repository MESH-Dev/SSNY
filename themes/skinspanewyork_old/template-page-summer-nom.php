<?php 
/**
Template Name:Landing: Summer - No Massage
 *
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="summer-nom-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-home-nom.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-centered-nom.jpg" alt="Background Image" /></a>
