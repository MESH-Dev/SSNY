<?php 
/**
Template Name:Landing: Take It Off (No LHR)
 *
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="take-it-off-nol-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/take-it-off-nol-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/take-it-off-nol-centered.jpg" alt="Take It Off! Spa Deals" /></a>
