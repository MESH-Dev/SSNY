<?php 
/**
Template Name:Landing: Page 6 Brand Campaign (black)
 *
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/p6.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="p6-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/p6weboffer.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/p6weboffer_mobile.jpg" alt="Background Image" /></a>
