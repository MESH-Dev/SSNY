<?php 
/**
Template Name:Landing: Fall - All Offers
 *
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/fall.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="fall-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/fall-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/fall-centered.jpg" alt="Background Image" /></a>
