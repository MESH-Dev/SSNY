<?php 
/**
Template Name:Landing: Murray Hill - Beautiful Skin
 *
 * Template for the Murray Hill - Beautiful Skin Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/murray-hill/styles/beautiful-skin.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="beautiful-skin-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/beautiful-skin-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/murray-hill/images/beautiful-skin-centered.jpg" alt="Background Image" /></a>
