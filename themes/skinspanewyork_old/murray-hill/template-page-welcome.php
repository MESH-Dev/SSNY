<?php 
/**
Template Name:Landing: Murray Hill - Welcome
 *
 * Template for the Murray Hill - Welcome Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/murray-hill/styles/welcome.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="welcome-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/welcome-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/murray-hill/images/welcome-centered.jpg" alt="Background Image" /></a>
