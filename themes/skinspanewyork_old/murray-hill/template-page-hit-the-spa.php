<?php 
/**
Template Name:Landing: Murray Hill - Hit the Spa
 *
 * Template for the Murray Hill - Hit the Spa Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/murray-hill/styles/hit-the-spa.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="hit-the-spa-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/hit-the-spa-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/murray-hill/images/hit-the-spa-centered.jpg" alt="Background Image" /></a>
