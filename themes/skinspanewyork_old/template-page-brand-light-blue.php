<?php 
/**
Template Name:Landing: Brand Light Blue
 *
 * Template for the Brand Light Blue Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/brand-light-blue.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="brand-light-blue-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/light-blue-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/light-blue-centered.jpg" alt="Background Image" /></a>
