<?php 
/**
Template Name:Landing: July 4th - All Offers
 *
 * Template for the July 4th Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/july-4th.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="july-4th-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/july-4th-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/july-4th-centered.jpg" alt="Background Image" /></a>
