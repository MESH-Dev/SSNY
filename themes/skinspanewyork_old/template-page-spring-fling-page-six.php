<?php 
/**
Template Name:Landing: Spring Fling - Page 6
 *
 * Template for the Spring Fling Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/spring-fling.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="spring-fling-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-home-skin-care.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-centered-skin-care.jpg" alt="Background Image" /></a>
				...
				<div class="shop-sales-wrapper">
					...
					<h1>5 EXCLUSIVE ONLINE OFFERS!</h1>
					
					<!-- BLOCK 1 -->
					
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							<h2>FOR THE FACE</h2>
							<h3>facial treatments</h3>
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/face-p6c-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
							<div class="service">
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h3>anti aging</h3>
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/anti-aging-p6c-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
							<div class="service">
							...
							<p class="terms">
								...
								**Valid for first time laser skin care clients only
							</p>
							<div class="clear"></div>
					</div>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/body-p6c-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/waxing-p6c-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service triple">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							<h2>FOREVER SMOOTH</h2>
							<h3>laser hair removal</h3>
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/laser-hair-removal-p6c-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
								SMALL AREA**<br />
								<strong>SALE $35</strong> (Reg $100)
							</p>
							<p>
								MEDIUM AREA**<br />
								<strong>SALE $55</strong> (Reg $150)
							</p>
						</div>
						<div class="or">OR</div>
						<div class="service">
							<h4 class="service-title">MULTI PACK SALE</h4>
							<p>
								3 PACK SMALL AREA**<br />
								<strong>SALE $99</strong> (Reg $300)
							</p>
							<p>
								2 PACK MEDIUM AREA**<br />
								<strong>SALE $99</strong> (Reg $300)
							</p>
						</div>
								
							<p class="terms">
								*Offers valid for first time Laser Hair Removal Customers<br />
								**Small Areas include Underarms, Basic Bikini, Upper Lip or Chin<br />
								***Medium Areas include Brazilian Bikini, Half Leg or Half Arm
							</p>
							<div class="clear"></div>							
					</div>				
