<?php 
/**
Template Name:Landing: Love 2014
 *
 * Template for the Love 2014 page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/love-2014.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="love-2014-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/love-2014-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/love-2014-centered.jpg" alt="Background Image" /></a>
				...
				<div class="shop-sales-wrapper">
					...
					<h1>Half Off Gift Certificates for Valentine's Day!</h1>
