 ...
 *
 * Template for the appointments page of the site
 *
 */
 ?>
<?php get_header() ?>
...
<ul class="location-list">
					...
					<?php if (get_post_meta($post->ID,'spabooker-url',true)): ?>
					
						<li class="desktop">
							<a class="location_block" href="<?php echo get_post_meta($post->ID,'spabooker-url',true); ?>" target="_blank">
						...
						<li class="mobile">
							<a class="location_block" href="<?php echo get_post_meta($post->ID,'mobile-url',true); ?>" target="_blank">
								<?php if(has_post_thumbnail()){
									the_post_thumbnail('',array('class'=>'img'));
									}
								?>
