<?php 
/**
Template Name:Landing: Summer - No LHR
 *
 * Template for the Summer No LHR Landing page of the site
 *
 */
 ?>
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="summer-nol-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-home-nol.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-centered-nol.jpg" alt="Summer Spa Deals!" /></a>
