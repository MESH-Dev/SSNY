<?php 
/**
Template Name:Landing: Spring Fling - No Massage
 *
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="spring-fling-nom-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-home-nom.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-centered-nom.jpg" alt="Background Image" /></a>
