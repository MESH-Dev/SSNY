...
<div id="single_product_page_container">
	...
	<?php
		// Breadcrumbs
		wpsc_output_breadcrumbs(array('crumb-separator' => '', 'show_home_page' => false));
...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
			...
			<div class="social_tools">
				...
				<h3>Don't keep this deal to yourself. Let your friends know!</h3>
							...
							<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
											...
											<input class="sksp_wpsc_buy_button" type="submit" value="<?php echo wpsc_product_external_link_text( wpsc_the_product_id(), __( 'Buy Now', 'wpsc' ) ); ?>" onclick="return gotoexternallink('<?php echo $action; ?>', '<?php echo wpsc_product_external_link_target( wpsc_the_product_id() ); ?>')">
											<?php else: ?>
