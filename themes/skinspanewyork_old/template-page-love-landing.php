<?php 
/**
Template Name:Landing: Love - Half off Gift Certs
 *
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a href="#purchase-gift-certificate"><img src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/love-gift-certificates-mobile.jpg" alt="Background Image" /></a>
							
				<div class="social-block">
					<div class="holder">
					
					<a name="purchase-gift-certificate"></a>
