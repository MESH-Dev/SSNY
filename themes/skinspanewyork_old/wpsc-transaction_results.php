...
?>
<div class="wrap transaction-results-page">
...
<?php
	...
	if ( ( true === $echo_to_screen ) && ( $cart != null ) && ( $errorcode == 0 ) && ( $sessionid != null ) ) {			
		...
		echo "<h2 class='transaction-thank-you'>Thank you</h2>";	

		echo wpautop(str_replace("$",'\$',$message_html));
...
fb_param.value = '<?php echo $purchase_log_data_item['price']; ?>';
