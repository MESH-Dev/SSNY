<?php 
/**
Template Name:Landing: Spring Fling - Anti Aging (no LHR)
 *
 * Template for the Spring Fling Anti Aging Landing page of the site
 *
 */
 ?>
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="spring-fling-anti-aging-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-home-anti-aging.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/spring-fling-centered-anti-aging.jpg" alt="Background Image" /></a>
