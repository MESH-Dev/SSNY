<?php 
/**
Template Name:Landing: It's All About You
 *
 * Template for the It's All About You Landing page of the site
 *
 */
 ?>
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="its-all-about-you-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/its-all-about-you-general-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/its-all-about-you-general.jpg" alt="Background Image" /></a>
