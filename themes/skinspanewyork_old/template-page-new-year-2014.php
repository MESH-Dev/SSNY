<?php 
/**
Template Name:Landing: New Year 2014 - All Offers
 *
 * Template for the New Year 2014 Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/new-year-2014.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="new-year-2014-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/new-year-2014-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/new-year-2014-centered.jpg" alt="Background Image" /></a>
