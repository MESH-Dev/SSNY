<?php 
/**
Template Name:Landing: Page 6 Brand Campaign (blue)
 *
 * Template for the Page 6 Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/p6-blue.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="p6-b-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/blue-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/blue-centered.jpg" alt="Background Image" /></a>
				...
				<div class="shop-sales-wrapper">
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<a href="<?php bloginfo('url'); ?>/store/face-p6b-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
							<div class="service">
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h3>anti aging</h3>
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/anti-aging-p6b-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
							<div class="service">
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/body-p6b-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/waxing-p6b-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/laser-hair-removal-p6b-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
