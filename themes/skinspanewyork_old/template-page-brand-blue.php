<?php 
/**
Template Name:Landing: Brand Campaign (blue)
 *
 * Template for the Brand Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/blue.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/blue-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/blue-centered.jpg" alt="Background Image" /></a>
