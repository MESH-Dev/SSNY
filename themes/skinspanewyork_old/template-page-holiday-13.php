<?php 
/**
Template Name:Landing: Holiday 2013
 *
 * Template for the Holiday 2013 page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/holiday-13.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="holiday-13-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/holiday-13-home.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/holiday-13-centered.jpg" alt="Background Image" /></a>
				...
				<div class="shop-sales-wrapper">
					...
					<h1>Gift Certificates and Exclusive Online Offers!</h1>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h3>for services & packages</h3>
							<h4 id="fifty-off">UP TO 50% OFF</h4>
						</div>
						<div class="gift-certificate">
							<?php echo do_shortcode("[wpsc_products product_id='676']"); ?>
						</div>
						<p class="terms gift-certificate-terms">
							* Cannot be combined with any other offers or promotions<br />
							** Valid on full - priced services and packages only<br />
							*** Not valid for tax and gratuity 
						</p>
						<div class="clear"></div>
					...
					<div class="shop-sale-block">
						<div class="shop-sale-title">
							...
							<h4>SINGLE OR MULTI-PACK</h4>
							<a href="<?php bloginfo('url'); ?>/store/laser-hair-removal-web-offers/" class="shop-sale-button" target="_blank">shop sale</a>
						</div>
						<div class="service">
							<h4 class="service-title">SINGLE SESSION SALE</h4>
							<p>
