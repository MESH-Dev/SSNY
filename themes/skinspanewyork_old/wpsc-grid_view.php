...
<?php wpsc_output_breadcrumbs(array('crumb-separator' => '', 'show_home_page' => false)); ?>
	...
	<div class="product_grid_display group">
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			<div class="sksp_product_grid_item product_view_<?php echo wpsc_the_product_id(); ?>">
				  
				<?php if(wpsc_the_product_thumbnail()) :?> 	   
					<div class="item_image">
						<a href="<?php echo wpsc_the_product_permalink(); ?>">
						<img style="width:100%;height:auto" class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_thumbnail(); ?>" />
						</a>
					</div><!--close imte_image-->
				<?php else: ?> 
					<div class="item_no_image">
									<a href="<?php echo wpsc_the_product_permalink(); ?>">
									<img class="no-image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="No Image" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo WP_CONTENT_URL; ?>/themes/skinspanewyork/wpsc-images/noimage.png" width="<?php echo get_option('product_image_width'); ?>" height="<?php echo get_option('product_image_height'); ?>" />
									</a>
				...
				<?php if(get_option('show_images_only') != 1): ?>
					<div class="sksp_grid_product_info">
						<div class="sksp_left">
							<h2 class="sksp_prodtitle"><a href="<?php echo wpsc_the_product_permalink(); ?>" title="<?php echo wpsc_the_product_title(); ?>"><?php echo wpsc_the_product_title(); ?></a></h2>
							
							<?php if(wpsc_product_on_special()) : ?>
									<p class="sksp_oldpricedisplay <?php echo wpsc_the_product_id(); ?>"><?php _e('(Reg', 'wpsc'); ?>: <span class="sksp_oldprice"><?php echo wpsc_product_normal_price(true); ?></span><?php _e(')', 'wpsc'); ?></p>
								<?php endif; ?>
							</div>
						...
						<?php endif; ?>
                        	<div class="price_container">
									...
									<p class="sksp_pricedisplay <?php echo wpsc_the_product_id(); ?>"><span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="sksp_currentprice sksp_pricedisplay"><?php echo wpsc_the_product_price(true); ?></span></p>
									
								
									
									
									<?php if(wpsc_show_pnp()) : ?>
										<p class="sksp_pricedisplay"><?php _e('Shipping', 'wpsc'); ?>:<span class="sksp_pp_price"><?php echo wpsc_product_postage_and_packaging(); ?></span></p>
									<?php endif; ?>	 
						...
						<div class="wpsc_variation_forms">
							...
							<?php if((get_option('display_addtocart') == 1) && (get_option('addtocart_or_buynow') !='1')) :?> 	   
								<?php if(wpsc_product_has_stock()) : ?>
									<input type="submit" value="<?php _e('Add To Cart', 'wpsc'); ?>" name="Buy" class="sksp_wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/>
								<?php else : ?>
