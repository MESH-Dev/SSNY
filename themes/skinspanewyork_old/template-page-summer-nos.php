<?php 
/**
Template Name:Landing: Summer - No Skin Care
 *
 * Template for the Summer Landing page of the site
 *
 */
 ?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('url'); ?>/wp-content/themes/skinspanewyork/styles/summer.css" />
...
<div id="wrapper">
		...
		<div id="main">
			<div class="top-block">
				<a id="summer-nos-offer-image" class="lp-offer-image" href="#sales" style="border-bottom:3px solid #A3884D;"><img data-src-767px="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-home-nos.jpg"  src="<?php echo WP_CONTENT_URL;?>/themes/skinspanewyork/images/summer-centered-nos.jpg" alt="Summer Spa Deals!" /></a>
