...
$options1[] = array("id" => "templatemela_main_after",
					"label" => "templatemela main after",
					"type" => "textarea",
					"description" => "Executed at afetr #main ID tag.");
