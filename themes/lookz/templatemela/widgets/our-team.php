...
class OurTeamWidget extends WP_Widget
{
    ...
    function widget($args, $instance){
		...
		if($is_template_path == 1):
			$image = get_template_directory_uri() . '/images/team/' . $image;
		endif;	
		echo $before_widget;
		 ?>
		<div class="one_fourth_team">
		<img src="<?php echo $image; ?>" alt="<?php echo $name; ?>"/>
		<div class="image-bottom"><div class="image-bottom_inner"></div></div>
		<div class="name">
			<h4><?php echo $name; ?></h4>
    ...
    function form($instance){
		$instance = wp_parse_args( (array) $instance, array('title'=>'','linkURL'=>'#','name'=>'AMY WINEHOUSE','designation'=>'social media manager','image'=>'team1.jpg','description'=>'','google'=>'#','facebook'=>'#','twitter'=>'#','linked_in'=>'#', 'is_template_path'=>1) );
