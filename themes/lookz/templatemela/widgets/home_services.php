...
class HomePageservicesWidget extends WP_Widget
{
    ...
    function widget($args, $instance){
		...
		echo $before_widget; 
		?> 
		<div class="service cms_shipping1 hb-animate-element bottom-to-top">
		<div class="icon">
		...
		<div class="text">
			...
			<div class="service-description"><?php echo wpautop($Services); ?></div>
    ...
    function form($instance){
		...
		'title'=>'Free Shipping ', 
		'imageSrc'=>'',
		'Services'=>'it has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged',
		'linkURL'=>'#',
		'window_target' => true,
		'icon'=>'service1',
		'window_target'=>''
