      ...
      echo $after_title; 
		 ?>
			<div id="branding">	
			  <div class="follow-me">
			   		<span> 
			   			<a  class="fb" href="<?php if($linkURL == ""): echo home_url( '/' ); else:?><?php echo $linkURL; endif;?>" <?php if($window_target == true) echo 'target="_blank"'; ?>> facebook </a> 
			  		</span> 
					
					<span> 
					 	<a  class="twitter" href="<?php if($linkURL2 == ""): echo home_url( '/' ); else:?><?php echo $linkURL2; endif;?>" <?php if($window_target == true) echo 'target="_blank"'; ?>> twitter </a> 
					</span> 
					
					<span> 
					 	<a  class="linkedin" href="<?php if($linkURL3 == ""): echo home_url( '/' ); else:?><?php echo $linkURL3; endif;?>" <?php if($window_target == true) echo 'target="_blank"'; ?>> linkedin </a> 
					</span> 
					
					<span> <a  class="rss" href="<?php if($linkURL4 == ""): echo home_url( '/' ); else:?> <?php echo $linkURL4; endif;?>" <?php if($window_target == true) echo 'target="_blank"'; ?>> rss </a> 
					</span>
			  </div>
			</div>
<?php
