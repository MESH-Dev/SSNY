...
class LatestNewsWidget extends WP_Widget
{
    ...
    function widget($args, $instance){
		...
		<div class="flexslider latestnews">
		<ul class="slides">
		<?php
		global $post;
		...
		<li class="post-img-dec">
			
			<div class="title-dec">
			  <?php $shorttitle = substr(the_title('','',FALSE),0,40); ?>
			 <?php /*?> <h3 class="home-featured"><?php echo $shorttitle; if (strlen($shorttitle) >30){ echo '&hellip;'; } ?></h3><?php */?>
			  <span class="expy-home"><?php echo templatemela_excerpt(70); ?></span> </div>
			  <div class="border_outer"><div class="comment_border"></div></div>
		</li>
    ...
    function form($instance){
		$instance = wp_parse_args( (array) $instance, array('title'=>'Latest News', 'featuredPostId'=>'' , 'if_latest_post' => true ,'postCount' => '3','featuredCat1' => '1','imageSrc' => '1') );
