...
class AboutWidget extends WP_Widget
{
    ...
    function form($instance){
		...
		'title'=>'Welcome to Our Compony', 
		'description' => 'simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since , when an unknown printer took a galley of type scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the software like Aldus.',
		'imageSrc'=>'', 
		'link_text'=>'', 
		'linkURL'=>'#'
		) );
