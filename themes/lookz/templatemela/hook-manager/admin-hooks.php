...
function templatemela_main_after() { do_action( 'templatemela_main_after' ); }			
add_action('templatemela_main_after', 'templatemela_id14', 20);
if ( ! function_exists( 'templatemela_id14' ) ) {
	function templatemela_id14() {
		echo stripslashes(get_option('templatemela_main_after'));
	}
}
...
add_action('templatemela_right_before', 'templatemela_id15', 20);
if ( ! function_exists( 'templatemela_id15' ) ) {
	function templatemela_id15() {
...
add_action('templatemela_custom_css', 'templatemela_id16', 20);
if ( ! function_exists( 'templatemela_id16' ) ) {
	function templatemela_id16() {	
