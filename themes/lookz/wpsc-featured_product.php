    ...
    <div class="wpsc_container wpsc_featured">
        <div class="featured_product_display">
            <div class="featured_product_display_item product_view_<?php $product->ID; ?>">               
                <div class="item_text">
                    <h1 class="entry-title"><a href='<?php echo get_permalink( $product->ID ); ?>'><?php echo get_the_title( $product->ID ); ?></a></h1>
					...
					<?php else: ?>					
						<div class="featured_item_no_image">
                    ...
                    <div class='featured_description'>
                        <?php echo wpe_excerpt(50); ?> 
						<div class="featured_read_more">
							<a href='<?php echo get_permalink( $product->ID ); ?>'><?php esc_html_e( 'More Information&hellip;', 'wpsc' ); ?></a>
						</div>
                    </div>
					<?php endif; ?>       
                </div>
