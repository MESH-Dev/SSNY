...
function templatemela_setup() {
	...
	set_post_thumbnail_size( 904, 270, true );
...
function templatemela_scripts_styles() {
	...
	wp_enqueue_style( 'templatemela-style', get_stylesheet_uri(), array(), ' ' );
...
<nav class="navigation paging-navigation" role="navigation">
  <h1 class="screen-reader-text">
    <?php _e( 'Posts navigation', 'templatemela' ); ?>
  </h1>
  <div class="nav-links">
    ...
    <div class="nav-previous">
      <?php next_posts_link( __( '<span class="meta-nav"></span> Older posts', 'templatemela' ) ); ?>
    </div>
    <?php endif; ?>
    <?php if ( get_previous_posts_link() ) : ?>
    <div class="nav-next">
      <?php previous_posts_link( __( 'Newer posts <span class="meta-nav"></span>', 'templatemela' ) ); ?>
    </div>
    <?php endif; ?>
    <?php endif; ?>
  </div>
...
<nav class="navigation post-navigation" role="navigation">
  <h1 class="screen-reader-text">
    <?php _e( 'Post navigation', 'templatemela' ); ?>
  </h1>
  <div class="nav-links">
