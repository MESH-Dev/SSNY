...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
				...
				*/
				...
				<?php do_action ( 'wpsc_product_form_fields_begin' ); ?>
					...
					<div class="productcol summary">
							 ...
							 */
							?>
							<h1 class="product_title entry-title <?php echo the_slug() ?>" itemprop="name"><?php echo wpsc_the_product_title(); ?></h1>
						...
						<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
							<?php if(wpsc_product_has_stock()) : ?>
								<div class="wpsc_buy_button_container">
										...
										<input class="wpsc_buy_button wpsc-buy-now-button" type="submit" value="<?php echo wpsc_product_external_link_text( wpsc_the_product_id(), __( 'Buy Now', 'wpsc' ) ); ?>" onclick="return gotoexternallink('<?php echo esc_url( $action ); ?>', '<?php echo wpsc_product_external_link_target( wpsc_the_product_id() ); ?>')">
										<?php else: ?>
									<input type="submit" value="<?php _e('Add To Cart', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button wpsc-add-to-cart-button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button" />
										<?php endif; ?>
					...
					<div id="faq-hidden" style="display:none">
					...
					<script type="text/javascript">
						jQuery( document ).ready(function(jQuery) {
							...
							var faqs = jQuery('#faq-hidden').html();
						    console.log( faqs );

						    if(faqs != ""){
						    	jQuery('#tabs ul.tabs').append('<li><a href="#tab-faqs" >FAQs<div class="extra"></div></a></li>');
						    	jQuery('.tab_content').append('<div id="tab-faqs" class="panel tabs_tab" style="display: none;"><div class="product_description">' + faqs + '</div><!--close product_description --> </div>');
						    }
					...
					<?php if(the_slug() == 'ss-membership'){
						 include('partials/_tabs_membership.php');
					 } ?>
          ...
          <?php if(the_slug() != 'ss-membership'){
                  include('partials/_tabs_default.php');
                } ?>
