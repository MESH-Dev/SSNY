...
?>
      ...
      <?php if(wpsc_has_tnc()) : ?>
         <tr>
            <td colspan='2'>
               <label for="agree"><input id="agree" type='checkbox' value='yes' name='agree' />
                   I agree to the 
                   <a class='termsandconds' href="#" data-featherlight="#disclaimer">Terms and Conditions</a>
                   <span class="asterix">*</span>
                   <div id="disclaimer" class="featherlightbox"><?php echo get_post(DISCLAIMER_PAGE_ID)->post_content ?></div>
               </label>
               </td>
         </tr>
      <?php endif; ?>
